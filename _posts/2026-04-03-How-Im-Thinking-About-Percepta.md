...
- **PR2:** People and organizations will defer more and more decisions to models. Already happening in consumer (search, writing, coding), beginning in enterprise. The trend is one-directional. As models get more capable the surface area of delegation expands. The bottleneck shifts from "can the model do this" to "can the organization hand this off."
