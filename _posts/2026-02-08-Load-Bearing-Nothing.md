...
- Remove the cognitive bottleneck and the load-bearing walls turn out to be <span class="highlight-text">vestigial</span>.
...
- <span class="highlight-text">The system can handle the problem. It cannot handle the person who has the problem.</span>
