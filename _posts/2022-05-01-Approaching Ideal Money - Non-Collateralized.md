...
- **Fractionally collateralized (<100%)**: FRAX operates at roughly 85% collateral ratio — each FRAX is backed by $0.85 in real collateral plus $0.15 in algorithmic mechanisms. This is the interesting middle ground.
